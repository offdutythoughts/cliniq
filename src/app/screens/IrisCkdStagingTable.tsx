...
const tdStage = (color: string) => s(`padding:8px 5px;font-size:var(--fs-chip-sub);font-weight:700;color:${color};border-bottom:1px solid ${BORDER};text-align:left;white-space:nowrap;`)
