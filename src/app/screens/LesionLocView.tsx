...
const CT: Record<string, Tone> = {
  ...
  'Structural': 'teal',     'Cardiac': 'danger',
  'Infectious': 'danger',   'Inflammatory': 'orange',
  'Neuromuscular': 'indigo','Dynamic collapse': 'indigo',
  ...
  'Foreign body': 'green',  'Dental': 'warning',
  ...
  'Sleep disorder': 'indigo','Stress': 'green',
  ...
  'Acquired': 'info',       'Primary': 'info',
  'Secondary': 'warning',   'Chronic': 'warning',
  'Trauma': 'danger',       'Haemorrhage': 'danger',
  'Haemolysis': 'danger',   'Coagulopathy': 'danger',
  'Consumptive': 'danger',  'Glaucoma': 'danger',
  'Drug': 'orange',         'Pharmacological': 'orange',
  'Muscle': 'orange',       'Motility': 'violet',
  'Prolapse': 'violet',     'Cystic': 'info',
  'Autonomic': 'indigo',    'Sympathetic': 'indigo',
  'Physiological': 'green', 'Pharyngeal': 'teal',
