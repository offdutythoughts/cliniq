...
function SettingsHome() {
  ...
  return (
    <div style={s('padding:4px 0 20px;')}>
      ...
      {/* Interactive tour entry point */}
      <div style={s('margin-top:24px;')}>
        <div style={s('font-size:11px;font-weight:700;color:var(--gray2);text-transform:uppercase;letter-spacing:.08em;margin-bottom:16px;')}>Get started</div>
        <button
          onClick={startTutorial}
          style={s('width:100%;padding:14px 16px;background:var(--navy2);border:1px solid var(--border);border-radius:14px;display:flex;align-items:center;gap:14px;cursor:pointer;text-align:left;')}
        >
          <div style={s('font-size:24px;line-height:1;flex-shrink:0;')}>🗺️</div>
          <div style={s('flex:1;')}>
            <div style={s('font-size:14px;font-weight:600;color:var(--white);margin-bottom:3px;')}>Take the interactive tour</div>
            <div style={s('font-size:12px;color:var(--gray);')}>A 6-step walkthrough of the key features</div>
          </div>
          <div style={s('font-size:16px;color:var(--gray2);')}>›</div>
        </button>
      </div>
