...
,
  ...
  protocols: [
    ...
    {id:'PROT-TOX-GRAPE',name:'Toxin: Grapes / Raisins / Sultanas / Currants',sp:'Dog',trigger:'Ingestion of grapes, raisins, sultanas, currants or products containing them (fruit cake, mince pies, trail mix)',priority:'URGENT',
     steps:[
       {n:1,action:'Treat ALL ingestions as potentially life-threatening regardless of quantity. Toxic mechanism is unknown and idiosyncratic — some dogs tolerate large amounts while others develop AKI after a single grape. There is NO established safe dose.',note:'Tartaric acid (concentrated in raisins/sultanas) is a candidate toxin. Raisins and sultanas are considered higher risk than fresh grapes due to concentration.',branch:'',flag:'⚠️ Do NOT calculate a safe dose — treat every exposure urgently'},
       {n:2,action:'Decontaminate aggressively if ingestion <2–4h: induce emesis (apomorphine 0.03–0.04 mg/kg IV/SC or conjunctival sac (rinse eye immediately after vomiting)). Activated charcoal 1–2 g/kg PO. Raisins are sticky — consider gastric lavage under GA if large ingestion and emesis incomplete.',note:'',branch:'',flag:''},
       {n:3,action:'IV access; baseline renal panel: BUN, creatinine, SDMA, phosphate, electrolytes, urinalysis (USG, sediment, casts). Document baseline values — AKI develops 24–72h post-ingestion and initial values may be normal.',note:'',branch:'',flag:''},
       {n:4,action:'IV fluid diuresis regardless of initial renal values: 0.9% NaCl or Hartmann\'s at 2–3× maintenance for minimum 48–72h. Target urine output >1–2 mL/kg/h. Place urinary catheter for accurate output monitoring if possible.',note:'Aggressive early diuresis is the mainstay of treatment — there is no specific antidote. Goal is prevention, not treatment of AKI.',branch:'Oligo/anuria despite adequate fluids → furosemide 1–2 mg/kg IV; mannitol 0.5 g/kg IV over 20 min',flag:''},
       {n:5,action:'Recheck renal panel at 24h and 48h: BUN, creatinine, phosphate, electrolytes, urinalysis. Casts in sediment and rising phosphate are poor prognostic indicators. Continue IV fluids minimum 48–72h.',note:'Phosphate elevation and hyperkalaemia signal severe AKI. SDMA may rise early and sensitively.',branch:'',flag:''},
       {n:6,action:'Prognosis: if renal values remain normal at 72h post-ingestion with maintained urine output — good. Once oliguric/anuric AKI established — guarded to poor without dialysis. Refer to specialist centre for haemodialysis if available.',note:'Seasonal risk: raisins in fruit cake, mince pies, hot cross buns, Christmas pudding, and trail mix.',branch:'',flag:''},
     ]},
