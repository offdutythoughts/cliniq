  ...
  protocols: [
    ...
    {id:'PROT-TOX-ALLIUM',name:'Toxin: Allium (Garlic / Onion / Leek / Chive)',sp:'Dog + Cat',trigger:'Ingestion of garlic, onion, leek, chive or products containing them; cats more sensitive',priority:'URGENT',
     steps:[
       ...
       {n:3,action:'Decontaminate if ingestion <2–4h and patient stable: induce emesis (dog: apomorphine 0.03–0.04 mg/kg IV/SC; cat: dexmedetomidine 7–10 mcg/kg IM). Activated charcoal 1–2 g/kg PO.',note:'Do not induce emesis if haemolysis already evident or patient vomiting. Charcoal binds n-propyl disulphide.',branch:'',flag:'⚠️ Cats: hydrogen peroxide causes haemorrhagic gastroenteritis — do not use'},
    ...
    {id:'PROT-TOX-CHOC',name:'Toxin: Chocolate / Theobromine',sp:'Dog',trigger:'Chocolate or cocoa ingestion; dose-dependent from mild GI to fatal cardiac arrhythmias',priority:'URGENT',
     steps:[
       ...
       {n:3,action:'Decontaminate if ingestion <2h and patient asymptomatic: induce emesis (apomorphine 0.03–0.04 mg/kg IV/SC). Activated charcoal 1–2 g/kg PO — repeat q4–6h (enterohepatic recirculation of theobromine).',note:'Chocolate delays gastric emptying — emesis may be productive beyond 2h. Do not induce if seizing or cardiovascularly compromised.',branch:'',flag:''},
    ...
    {id:'PROT-TOX-XYLITOL',name:'Toxin: Xylitol (Sugar-Free Products)',sp:'Dog',trigger:'Ingestion of xylitol-containing products — sugar-free gum, sweets, peanut butter, mouthwash, medications',priority:'URGENT',
     steps:[
       ...
       {n:2,action:'Decontaminate if ingestion <30–60 min and patient not yet hypoglycaemic: induce emesis (apomorphine 0.03–0.04 mg/kg IV/SC). Do NOT induce emesis if already showing hypoglycaemia or hepatic signs.',note:'Xylitol stimulates insulin secretion within 30–60 min. Hepatotoxicity at higher doses develops 12–72h later.',branch:'',flag:''},
    ...
    {id:'PROT-TOX-GRAPE',name:'Toxin: Grapes / Raisins / Sultanas / Currants',sp:'Dog',trigger:'Ingestion of grapes, raisins, sultanas, currants or products containing them (fruit cake, mince pies, trail mix)',priority:'URGENT',
     steps:[
       ...
       {n:2,action:'Decontaminate aggressively if ingestion <2–4h: induce emesis (apomorphine 0.03–0.04 mg/kg IV/SC). Activated charcoal 1–2 g/kg PO. Raisins are sticky — consider gastric lavage under GA if large ingestion and emesis incomplete.',note:'',branch:'',flag:''},
    ...
    {id:'PROT-TOX-PARA',name:'Toxin: Paracetamol (Acetaminophen)',sp:'Dog + Cat',trigger:'Paracetamol exposure; cats are hypersensitive — any dose is potentially fatal',priority:'URGENT',
     steps:[
       ...
       {n:2,action:'Decontaminate if ingestion <2h and patient stable: induce emesis (dog: apomorphine 0.03–0.04 mg/kg IV/SC; cat: dexmedetomidine 7–10 mcg/kg IM). Activated charcoal 1–2 g/kg PO.',note:'Do not induce emesis if methaemoglobinaemia signs already present.',branch:'',flag:''},
    ...
    {id:'PROT-TOX-NSAID',name:'Toxin: NSAIDs (Ibuprofen / Naproxen)',sp:'Dog + Cat',trigger:'Human NSAID ingestion; ibuprofen most common OTC exposure; cats sensitive to any NSAID',priority:'URGENT',
     steps:[
       ...
       {n:2,action:'Decontaminate if ingestion <2h: induce emesis (dog: apomorphine 0.03–0.04 mg/kg IV/SC; cat: dexmedetomidine 7–10 mcg/kg IM). Activated charcoal 1–2 g/kg PO — repeat q4–6h (enterohepatic recirculation). Do not induce if GI signs already present.',note:'NSAIDs delay gastric emptying — emesis may be productive beyond 2h.',branch:'',flag:''},
    ...
    {id:'PROT-TOX-ACRM',name:'Toxin: Anticoagulant Rodenticides (Bromadiolone / Brodifacoum)',sp:'Dog + Cat',trigger:'Known or suspected rodenticide ingestion; unexplained coagulopathy or haemorrhage',priority:'URGENT',
     steps:[
       ...
       {n:2,action:'If recent ingestion (<4h, no active bleeding): decontaminate immediately — apomorphine 0.03–0.04 mg/kg IV/SC; activated charcoal 1–2 g/kg PO. If already bleeding: do NOT induce emesis — proceed to treatment.',note:'PT prolongs first (factor VII shortest half-life ~6h). Do not check coagulation at presentation — values are normal for 36–72h post-ingestion.',branch:'',flag:'⚠️ Do NOT check PT/aPTT at presentation — will be normal; recheck at 48–72h'},
    ...
    {id:'PROT-TOX-METAL',name:'Toxin: Metaldehyde (Slug / Snail Bait)',sp:'Dog + Cat',trigger:'Access to slug pellets; acute-onset tremors, hyperthermia, and ataxia; blue-green pellets in vomitus',priority:'IMMEDIATE',
     steps:[
       ...
       {n:2,action:'Decontaminate ONLY if ingestion <30 min and NO tremors: induce emesis (apomorphine 0.03–0.04 mg/kg IV/SC dog). If tremors already present: DO NOT induce emesis — aspiration risk. Activated charcoal 1–2 g/kg PO if patient can swallow safely.',note:'',branch:'',flag:''},
