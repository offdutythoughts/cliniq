  ...
  history: {
    ...
    blocks: [
      ...
      { kind: 'step', text: '📋 STEP 1 — ONSET + PROGRESSION', noArrowAfter: true },
      {
        ...
        rows: [
          [`${numBadge(1)}<strong>Peracute</strong><br>hours`, { text: bullets(['Trauma', 'Splenic / hepatic mass rupture (HSA, hepatocellular ca)', 'Severe coagulopathy (rodenticide overdose, snake envenomation)', 'Heatstroke-induced DIC']), tone: 'teal' }],
          [`${numBadge(2)}<strong>Acute</strong><br>days`, { text: bullets(['IMTP onset', 'Rodenticide intoxication', 'Acute sepsis with DIC', 'IMHA-related secondary DIC', 'Acute liver failure']), tone: 'teal' }],
          [`${numBadge(3)}<strong>Subacute</strong><br>weeks`, { text: bullets(['Tick-borne disease (Ehrlichia · Anaplasma · Babesia — anaemia + thrombocytopenia ± neuro)', 'Chronic hepatic disease', 'Occult neoplasia with DIC', 'Intermittent IMTP relapse']), tone: 'teal' }],
          [`${numBadge(4)}<strong>Chronic / lifelong</strong>`, { text: bullets(['Inherited coagulopathies (haemophilia A — factor VIII; haemophilia B — factor IX; vWD types I–III)', 'Thrombocytopathies (Glanzmann, Scott syndrome)', 'Heritable vasculopathies']), tone: 'teal' }],
      ...
      { kind: 'step', text: '💊 STEP 2 — DRUG / TOXIN / EXPOSURE HISTORY', noArrowAfter: true },
      {
        ...
        rows: [
          ['<strong>Anticoagulants / rodenticides</strong>', { text: bullets(['Warfarin', 'Brodifacoum', 'Bromadiolone', 'Difenacoum (2nd-generation — last weeks). Bait colour turquoise / pink / green — variable']), tone: 'teal' }],
          ['<strong>Antiplatelet drugs</strong>', { text: bullets(['Aspirin', 'Clopidogrel', 'NSAIDs (carprofen, meloxicam — at supratherapeutic doses)']), tone: 'teal' }],
          ['<strong>Cytotoxic chemotherapy</strong>', { text: bullets(['Vincristine', 'Doxorubicin → thrombocytopenia']), tone: 'teal' }],
          ['<strong>Snake / spider envenomation</strong>', { text: bullets(['Rattlesnake (combined primary + secondary defect)', 'Australian elapids (procoagulant + neurotoxic)', 'Brown recluse / Latrodectus']), tone: 'teal' }],
          ...
          ['<strong>Plant toxins</strong>', { text: bullets(['Mouldy sweet clover hay (Melilotus — dicoumarol; primarily a livestock toxicity, anecdotally reported in dogs)', 'Bracken (thrombocytopenia in livestock)', 'Foxglove (cardiac)']), tone: 'teal' }],
      ...
      { kind: 'step', text: '🩺 STEP 3 — SYSTEMIC / FAMILY / BREEDING HISTORY', noArrowAfter: true },
      {
        ...
        rows: [
          [bullets(['Doberman', 'Sheltie', 'Golden Retriever', 'Scottish Terrier']), { text: bullets(['Doberman type I', 'Scottie type III is most severe'], { lead: '<strong>vWD</strong>' }), tone: 'teal' }],
          ['German Shepherd', { text: '<strong>Haemophilia A</strong> (factor VIII)', tone: 'teal' }],
          [bullets(['Boxer', 'Cairn Terrier']), { text: 'Factor VIII or factor IX', tone: 'teal' }],
          ['Otterhound', { text: 'Glanzmann thrombasthenia', tone: 'teal' }],
          ['Beagle', { text: 'Factor VII deficiency — usually asymptomatic', tone: 'teal' }],
          [bullets(['GSD (familial cutaneous vasculopathy)', 'Jack Russell', 'Greyhound', 'Scottish Terrier', 'Saint Bernard', 'Shar-Pei']), { text: 'Breed-predisposed <strong>cutaneous vasculitis</strong>', tone: 'teal' }],
        ],
      },
      {
        kind: 'gridTable',
        ...
        rows: [
          ...
          ['<strong>Geographic</strong>', { text: bullets(['Leishmania (Mediterranean / imported)', 'Crotalus envenomation', 'Brown recluse spider']), tone: 'teal' }],
          ...
          ['<strong>Previous transfusion / blood products</strong>', { text: bullets(['Alloimmunisation', 'Post-transfusion purpura (rare)']), tone: 'teal' }],
        ],
      },
    ...
    after: [
      {
        ...
        items: [
          ...
          `Petechiae + epistaxis + haematuria = IMTP / DIC`,
          `Acute bleeding + concurrent sepsis / neoplasia / IMHA / pancreatitis = DIC`,
          `Older intact male + feminisation + bleeding = Sertoli cell tumour`,
          `Bleeding in any breed with breed-known coagulopathy = test pre-operatively!`,
        ],
      },
      { kind: 'disclaimer' },
    ],
  ...
  exam: {
    ...
    blocks: [
      { kind: 'step', text: '🩺 STEP 1 — FROM A DISTANCE', noArrowAfter: true },
      {
        ...
        rows: [
          [`${numBadge(1)}<strong>Mentation + perfusion</strong>`, { text: bullets(['Collapsed', 'Tachycardic', 'Weak pulses → <strong>haemorrhagic shock</strong> (cavity bleed, severe envenomation)']), tone: 'danger' }],
          [`${numBadge(2)}<strong>Mucous membranes</strong>`, { text: bullets(['Pale (blood loss)', 'Petechiae (thrombocytopenia, vasculitis)', 'Icteric (concurrent haemolysis / hepatic failure)']), tone: 'teal' }],
          [`${numBadge(3)}<strong>Abdominal distension</strong>`, { text: bullets(['Haemoperitoneum — HSA rupture', 'Rodenticide', 'Hepatic mass']), tone: 'teal' }],
          ...
          [`${numBadge(6)}<strong>Skin lesions</strong>`, { text: bullets(['Petechiae (ventrum · sclera · oral mucosa · pinnae)', 'Ecchymoses', 'Vasculitis ulcers', 'Alopecia of Sertoli hyperestrogenism']), tone: 'teal' }],
        ],
      },
      { kind: 'step', text: '👋 STEP 2 — FOCUSED EXAM', noArrowAfter: true },
      {
        ...
        rows: [
          ['<strong>Petechiae location</strong>', { text: bullets(['Ventral abdomen', 'Axilla', 'Oral mucosa (especially upper canine pillar)', 'Conjunctiva', 'Pinnae', 'Sclera', 'Pads. Quantify — few / scattered / generalised']), tone: 'teal' }],
          ['<strong>Ecchymoses</strong>', { text: bullets(['Mild bruising at venepuncture sites', 'Ascending from injection sites', 'Spontaneous large bruises = severe']), tone: 'teal' }],
          ['<strong>Mucous membrane bleeding</strong>', { text: bullets(['Gingival ooze', 'Epistaxis (especially Doberman vWD)', 'Retinal haemorrhage', 'Oral haemorrhage post-meal']), tone: 'teal' }],
          ['<strong>Abdominal palpation</strong>', { text: bullets(['Pain', 'Fluid wave', 'Masses (splenic / hepatic — <strong>do not palpate a suspected mass aggressively</strong>)', 'Bladder for haematuria']), tone: 'teal' }],
          ['<strong>Thoracic auscultation + percussion</strong>', { text: 'Muffled sounds + dyspnoea = haemothorax', tone: 'teal' }],
          ['<strong>Lymphadenopathy</strong>', { text: bullets(['Lymphoma', 'Ehrlichiosis', 'Leishmaniasis']), tone: 'teal' }],
          ['<strong>Joint palpation</strong>', { text: bullets(['Haemarthrosis (warm, swollen, painful — factor deficiency)', 'Polyarthritis (vasculitis, SLE)']), tone: 'teal' }],
          ['<strong>Testicular palpation</strong> (intact male)', { text: 'Sertoli cell tumour — asymmetric firm mass + feminisation', tone: 'teal' }],
          ['<strong>Rectal exam</strong>', { text: bullets(['Melena (upper GI bleed)', 'Haematochezia (lower GI)', 'Prostatic disease', 'Anal sac mass']), tone: 'teal' }],
          ['<strong>Spinal palpation</strong>', { text: bullets(['Vertebral haemorrhage', 'Spinal IVDD with subarachnoid bleed']), tone: 'teal' }],
          ['<strong>Skin / coat</strong>', { text: bullets(['Vasculitis lesions (ulcers · ear-tip necrosis · footpad ulcers — pinnae especially)', 'Bilaterally symmetrical alopecia of hyperestrogenism', 'Cushingoid changes (HAC predisposes to PTE not bleeding, but iatrogenic steroid use predisposes to GI ulcer / haemorrhage)']), tone: 'teal' }],
        ],
      },
      { kind: 'step', text: '🔍 STEP 3 — PATTERN RECOGNITION', noArrowAfter: true },
      {
        kind: 'patterns',
        rows: [
          { section: 'Primary haemostasis — platelet · vWF' },
          { cues: ['Generalised petechiae', 'ecchymoses', 'mucosal bleeds', 'platelet count &lt;30 ×10⁹/L'], dx: 'IMTP (primary or 2°)', tone: 'danger', emphasis: true },
          { cues: ['Doberman or Sheltie with epistaxis', 'prolonged BMBT', 'normal platelet count'], dx: 'von Willebrand disease', tone: 'warning' },
          { section: 'Cavity bleed · secondary haemostasis' },
          { cues: ['Acute haemoperitoneum', 'collapse', 'pale gums', 'older large breed dog'], dx: 'Splenic / hepatic HSA rupture', tone: 'danger', emphasis: true },
          { cues: ['Haemothorax', 'cough / dyspnoea', 'history of access to bait'], dx: 'Anticoagulant rodenticide', tone: 'danger' },
          { cues: ['Haemarthrosis', 'young male dog', 'family history'], dx: 'Haemophilia A / B (X-linked)', tone: 'violet' },
          { cues: ['Petechiae', 'cavity bleed', 'sepsis / neoplasia / pancreatitis / IMHA'], dx: 'DIC', tone: 'danger', emphasis: true },
          { section: 'Systemic · acquired' },
          { cues: ['Intact male dog', 'feminisation', 'bilateral alopecia', 'pancytopenia'], dx: 'Sertoli cell tumour with hyperestrogenism', tone: 'danger' },
          { cues: ['Ear-tip / footpad necrosis', 'crusting', 'cutaneous ulcers'], dx: 'Cutaneous vasculitis', tone: 'violet' },
          { cues: ['Bleeding', 'acute renal failure', 'skin ulcers', 'sighthound'], dx: 'CRGV / "Alabama rot"', tone: 'danger' },
          { cues: ['Concurrent anaemia', 'thrombocytopenia', 'tick exposure'], dx: 'Tick-borne — Ehrlichia · Anaplasma · Babesia', tone: 'green' },
          { cues: ['Jaundice', 'ascites', 'bleeding'], dx: 'Hepatic failure', tone: 'danger' },
          { section: '🐱 Feline-specific' },
          { cues: ['🐱 FIP / lymphoma / cytauxzoon + thromboembolic signs (acute hindlimb paresis, pulmonary signs)', 'minimal external bleeding'], dx: 'Feline DIC (thrombotic phenotype) — grave', tone: 'info', emphasis: true },
          { cues: ['🐱 Birman / Siamese / DSH with isolated aPTT prolongation pre-op', 'no bleeding'], dx: 'Factor XII deficiency — clinically silent', tone: 'info' },
          { cues: ['Mediterranean / African origin cat with regenerative anaemia', 'FeLV positive'], dx: 'Babesia felis', tone: 'info' },
        ],
      },
    ],
  ...
  dx: {
    ...
    blocks: [
      { kind: 'step', tone: 'danger', text: '⚡ STEP 1 — STABILISE FIRST', noArrowAfter: true },
      {
        ...
        rows: [
          [`${numBadge(1)}<strong>ABC + shock assessment</strong>`, { text: bullets(['IV access (avoid jugular if coagulopathy suspected — use peripheral)', 'Oxygen', 'IV crystalloid bolus', 'Transfuse (whole blood, packed RBC, plasma) if life-threatening haemorrhage']), tone: 'danger' }],
          [`${numBadge(2)}<strong>Blood sampling order matters</strong>`, { text: bullets(['Minimise venepuncture sites', 'Small-gauge needles', 'Pressure for ≥5 min. Send CBC', 'Biochem', 'Coag profile (PT, aPTT)', 'Blood smear ± buccal mucosal bleeding time (BMBT) if cooperative']), tone: 'teal' }],
          [`${numBadge(3)}<strong>Empirical therapy while awaiting results</strong>`, { text: bullets(['Vitamin K1 5 mg/kg <strong>SC</strong> (NOT IV — anaphylaxis) for any suspected rodenticide', 'Fresh frozen plasma if active cavity bleeding and PT/aPTT severely prolonged']), tone: 'teal' }],
          ...
          [`${numBadge(5)}<strong>Type and cross-match</strong> before transfusion`, { text: bullets(['🐱 Typing is <strong>mandatory</strong> — Type B cats carry strong naturally-occurring anti-A antibodies and react severely (potentially fatally) to Type A blood', 'Type A cats have weak anti-B (mild reaction)', 'Type AB cats have neither antibody and are universal recipients']), tone: 'danger' }],
        ],
      },
  ...
  <table style="width:100%;border-collapse:collapse;font-size:9px;">
    ...
    <tbody>
      ...
      { kind: 'step', text: '🔬 STEP 3 — ADVANCED / SPECIALIST TESTS', noArrowAfter: true },
      {
        ...
        rows: [
          ['<strong>vWF antigen + collagen-binding activity</strong><br>referral lab', { text: bullets(['Screen Doberman', 'Sheltie', 'Scottie', 'Golden Retriever pre-operatively; differentiates type I, II, III']), tone: 'teal' }],
          ['<strong>Specific factor assays</strong>', { text: bullets(['VIII', 'IX', 'XI', 'XII (haemophilia and intrinsic deficiencies)', 'Factor VII (Beagle)', 'Fibrinogen (afibrinogenaemia)']), tone: 'teal' }],
          ['<strong>Platelet function testing</strong>', { text: bullets(['PFA-100 closure time', 'Multiplate aggregometry', 'Flow cytometry (Glanzmann, Scott syndrome)']), tone: 'teal' }],
          ['<strong>TEG / ROTEM</strong>', { text: bullets(['Global haemostasis — useful in DIC', 'Hepatic failure', 'Hyperfibrinolysis (Greyhound post-op bleeding)']), tone: 'teal' }],
          ...
          ['<strong>Bone marrow aspirate + core biopsy</strong>', { text: bullets(['Persistent unexplained pancytopenia', 'Refractory ITP', 'Suspected myelodysplasia, leukaemia, myelophthisis']), tone: 'teal' }],
          ...
          ['<strong>Abdominal + thoracic imaging</strong>', { text: bullets(['HSA / hepatic mass', 'Mediastinal mass', 'Retroperitoneal haemorrhage', 'Splenic / hepatic rupture']), tone: 'teal' }],
        ],
      },
      { kind: 'step', text: '💉 STEP 4 — TREATMENT POINTERS', noArrowAfter: true },
      {
        ...
        rows: [
          ['<strong>Anticoagulant rodenticide</strong>', { text: bullets(['Vitamin K1 PO 3–5 mg/kg divided BID × 28 d (2nd-generation; 14 d for 1st generation)', 'FFP / PCC if active bleeding', 'Recheck PT 72 h after last dose']), tone: 'teal' }],
          ...
          ['<strong>vWD</strong>', { text: bullets(['Cryoprecipitate or fresh frozen plasma', 'Desmopressin (DDAVP) 1 µg/kg SC 30 min pre-op (releases stored vWF — works in Type I, <strong>not</strong> III)', 'Avoid platelet inhibitors']), tone: 'teal' }],
          ['<strong>Haemophilia A / B</strong>', { text: bullets(['Fresh frozen plasma (FVIII or FIX)', 'Recombinant factor concentrate where available', 'Cage rest', 'Avoid IM', 'Lifelong management of bleeding episodes']), tone: 'teal' }],
          ['<strong>DIC</strong>', { text: bullets(['Treat the underlying cause aggressively. FFP for clotting factor replacement', 'Cryoprecipitate if hypofibrinogenaemic', 'Heparin controversial. Goals: maintain perfusion, treat the cause, support coagulation']), tone: 'teal' }],
          ['<strong>Splenic / hepatic HSA rupture</strong>', { text: bullets(['Stabilise + emergency splenectomy / partial hepatectomy', 'Staging (thoracic CT · abdominal US · cardiac echo for right atrial HSA)', 'Doxorubicin-based chemotherapy post-op — median survival 6–8 months even with multimodal therapy']), tone: 'teal' }],
          ['<strong>Sertoli cell tumour</strong>', { text: bullets(['Castration — resolves hyperestrogenism over 4–8 weeks', 'Pre-op bone marrow protection: transfusion support, antibiotic prophylaxis', 'Prognosis good if treated before irreversible marrow aplasia']), tone: 'teal' }],
          ['<strong>Cutaneous vasculitis</strong>', { text: bullets(['Identify and treat trigger (drug · infection · immune-mediated · neoplasia). Pentoxifylline 15–25 mg/kg BID + ω-3 fatty acids', 'Immunosuppression for severe / progressive disease']), tone: 'teal' }],
          ['<strong>Hepatic failure-related bleeding</strong>', { text: bullets(['Vitamin K1 (some response if factor synthesis still possible)', 'FFP for active bleeding', 'Correct hypoglycaemia and electrolytes', 'Manage hepatic encephalopathy (lactulose)']), tone: 'teal' }],
          ...
          ['<strong>Snake envenomation</strong>', { text: bullets(['Antivenom (region-specific)', 'Supportive care', 'FFP for cascade defect', 'Monitor renal function (myoglobinuria, AKI)']), tone: 'teal' }],
        ],
      },
    ],
    after: [
