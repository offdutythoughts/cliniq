    ...
    history: {
      ...
      blocks: [
        ...
        ...stepTable(1, 'WATCH THE PATIENT EAT & LOCALISE', {
          ...
          rows: [
            [`${numBadge(1)}<strong>Oral</strong><br>prehension / mastication`, { text: bullets(['Drops food', 'Drools', 'Pain on opening the mouth', 'Pawing at the face', 'Tilts the head to chew']), tone: 'teal' }],
            [`${numBadge(2)}<strong>Pharyngeal / cricopharyngeal</strong>`, { text: bullets(['Repeated swallowing attempts', 'Gagging', 'Coughing or nasal reflux while eating', 'The bolus won\'t clear the throat']), tone: 'teal' }],
            [`${numBadge(3)}<strong>Oesophageal</strong>`, { text: bullets(['Passive regurgitation of undigested food / saliva (variable timing after eating)', 'Cervical oesophageal distension', 'Weight loss despite a good appetite']), tone: 'teal' }],
          ],
        }, '👀'),
        ...
        ...stepTable(2, 'SIGNALMENT, AGE & BREED', {
          ...
          rows: [
            ['<strong>Young dog at weaning</strong>', { text: bullets(['<strong>Cricopharyngeal achalasia</strong> (Cocker Spaniel · Golden Retriever)', '<strong>Vascular ring anomaly / PRAA</strong> (German Shepherd · Irish Setter — regurgitation of solids as it starts on solid food)', 'Congenital megaoesophagus (Shar-Pei · GSD · Great Dane · Irish Setter · Labrador · Newfoundland)']), tone: 'teal' }],
            ['<strong>Adult dog</strong>', { text: bullets(['Acquired megaoesophagus (idiopathic, or secondary to MG · hypothyroidism · hypoadrenocorticism · lead)', 'Oesophagitis', 'Stricture', 'Foreign body', 'Neoplasia']), tone: 'teal' }],
            ['<strong>MG signalment</strong>', { text: bullets(['Bimodal — &lt;4 yr or &gt;9 yr. Akita', 'GSP', 'Chihuahua', 'GSD', 'Golden Retriever overrepresented']), tone: 'teal' }],
            ['<strong>Masticatory myositis</strong>', { text: bullets(['Painful / swollen then atrophied jaw muscles', 'Inability to open the mouth']), tone: 'teal' }],
          ],
        }, '🐾'),
        ...
        ...stepTable(3, 'ONSET, COURSE & EXPOSURES', {
          ...
          rows: [
            ...
            ['<strong>Toxin access</strong>', { text: bullets(['Lead', 'Organophosphate / anticholinesterase', 'Thallium']), tone: 'teal' }],
      ...
      blocks: [
        ...
        ...stepTable(1, 'ORAL EXAMINATION (often needs sedation)', {
          ...
          rows: [
            ...
            ['<strong>Teeth &amp; mucosa</strong>', { text: bullets(['Dental / periodontal disease', 'Oral masses', 'Stomatitis', 'Cleft palate']), tone: 'teal' }],
            ['<strong>Foreign bodies</strong>', { text: 'E.g. a stick lodged across the palate', tone: 'teal' }],
            ['<strong>Jaw &amp; orbit</strong>', { text: bullets(['TMJ disorder', 'Retrobulbar abscess (pain on opening + exophthalmos)']), tone: 'teal' }],
            ['<strong>Salivary swellings</strong>', { text: 'Mucocele / sialocele', tone: 'teal' }],
            ['<strong>Tonsils / pharynx</strong>', { text: bullets(['Inflammation', 'Masses <span style="opacity:.7">(Ettinger Ch 47)</span>']), tone: 'teal' }],
          ],
        }, '👄'),
        ...
        ...stepTable(2, 'NEUROLOGIC EXAM (cranial nerves)', {
          ...
          rows: [
            ['<strong>CN V</strong>', { text: bullets(['Masticatory muscle bulk / symmetry', 'Dropped jaw (bilateral)', 'Facial hypalgesia']), tone: 'teal' }],
            ['<strong>CN VII</strong>', { text: 'Facial paresis — lip / cheek control of the bolus', tone: 'teal' }],
            ['<strong>CN IX / X</strong>', { text: bullets(['Reduced gag', 'Dysphagia', 'Dysphonia', 'Laryngeal paralysis', 'Megaoesophagus'], { lead: '<strong>Gag reflex</strong>' }), tone: 'teal' }],
            ['<strong>CN XII</strong>', { text: 'Tongue strength / symmetry — lingual paresis', tone: 'teal' }],
            ['<strong>Generalised</strong>', { text: bullets(['Exercise-induced weakness (MG)', 'Neck ventroflexion', 'LMN polyneuropathy signs (polyradiculoneuritis) <span style="opacity:.7">(Ettinger Ch 47)</span>']), tone: 'teal' }],
          ],
        }, '🧠'),
        ...
        ...stepTable(4, 'THORACIC AUSCULTATION & GENERAL', {
          ...
          rows: [
            ['<strong>Thoracic auscultation</strong>', { text: bullets(['Crackles / increased lung sounds of <strong>aspiration pneumonia</strong> — cranioventral', 'The major complication']), tone: 'danger' }],
            ['<strong>Body condition</strong>', { text: 'Weight loss', tone: 'teal' }],
            ['<strong>Neck</strong>', { text: 'Cervical oesophageal distension', tone: 'teal' }],
            ['<strong>Systemic signs</strong>', { text: bullets(['Fever', 'Endocrine clues (hypothyroid coat changes)', 'Neuromuscular signs <span style="opacity:.7">(Ettinger Ch 47)</span>']), tone: 'teal' }],
          ],
        }, '🫁'),
      ],
      ...
      blocks: [
        { kind: 'step', tone: 'danger', text: '📊 STEP 1 — THORACIC RADIOGRAPHS (every dysphagic patient)', noArrowAfter: true },
        {
          ...
          rows: [
            ...
            ['<strong>Looking for</strong>', { text: bullets(['<strong>Megaoesophagus</strong>', '<strong>Aspiration pneumonia</strong> (cranioventral alveolar pattern)']), tone: 'teal' }],
        ...
        ...stepTable(2, 'VFSS / CONTRAST SWALLOW STUDY (the key functional test)', {
          ...
          rows: [
            ...
            ['<strong>What it defines</strong>', { text: bullets(['<strong>Cricopharyngeal achalasia vs dyssynchrony</strong> (timing of upper-sphincter relaxation against the pharyngeal contraction — the distinction changes the surgery)', 'Segmental oesophageal dysmotility', 'The <strong>LES achalasia-like syndrome (LES-AS)</strong>', 'Sliding hiatal hernia — all better than static radiographs']), tone: 'teal' }],
        ...
        ...stepTable(3, 'OESOPHAGOSCOPY', {
          ...
          headers: ['', { text: 'Detail', tone: 'teal' }],
          rows: [
            ['<strong>What it assesses and treats</strong>', { text: bullets(['<strong>Oesophagitis</strong>', '<strong>Stricture</strong> (and balloon dilation)', '<strong>Foreign body</strong> (retrieval)', 'Diverticulum', 'Neoplasia', 'The gastro-oesophageal junction']), tone: 'teal' }],
            ['<strong>Sequencing</strong>', { text: bullets(['Image (thoracic rads ± contrast) first', 'Endoscope when a mucosal / obstructive lesion is suspected or when retrieval or dilation is planned <span style="opacity:.7">(Ettinger Ch 47)</span>']), tone: 'teal' }],
          ],
        }, '🔬'),
        ...
        ...stepTable(4, 'TEST FOR SECONDARY / NEUROMUSCULAR CAUSES', {
          ...
          rows: [
            ['<strong>AChR antibody titre</strong>', { text: bullets(['Gold standard for <strong>myasthenia gravis</strong> (≈98% sensitive in dogs)', 'Megaoesophagus occurs in 84% of dogs / 40% of cats with generalised MG. A negative titre does <strong>not</strong> fully exclude focal / seronegative MG']), tone: 'teal' }],
            ['<strong>Type 2M-fibre (masticatory muscle) antibody</strong>', { text: bullets(['<strong>Masticatory myositis</strong> when the jaw muscles are painful / atrophied', 'Biopsy if equivocal']), tone: 'teal' }],
            ['<strong>Endocrine</strong>', { text: bullets(['Total / free T4 + TSH (hypothyroidism)', 'Basal cortisol / ACTH stimulation (hypoadrenocorticism)']), tone: 'teal' }],
            ['<strong>Toxin screens</strong>', { text: bullets(['Blood lead', 'Cholinesterase activity where exposure is plausible']), tone: 'teal' }],
