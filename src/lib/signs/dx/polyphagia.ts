    ...
    history: {
      ...
      blocks: [
        { kind: 'goal', text: 'GOAL: CONFIRM POLYPHAGIA & ESTABLISH THE WEIGHT TREND' },
        {
          ...
          rows: [
            ['<strong>Weight GAIN</strong>', { text: bullets(['Drug-induced', 'Hyperadrenocorticism', 'Insulinoma', 'Overfeeding']), tone: 'teal' }],
        ...
        { kind: 'step', tone: 'danger', text: '💊 STEP 1 — DRUG & DIET HISTORY FIRST', noArrowAfter: true },
        {
          ...
          rows: [
            ['<strong>Appetite-driving drugs</strong>', { text: bullets(['<strong>Glucocorticoids</strong>', '<strong>Anticonvulsants</strong> (phenobarbital · potassium bromide)', '<strong>Benzodiazepines</strong>', 'Antihistamines', 'Cyproheptadine / mirtazapine', '<strong>Progestins</strong> — signs resolve on withdrawal']), tone: 'danger' }],
            ['<strong>Dietary / behavioural</strong>', { text: bullets(['New palatable food', 'Food competition', 'Simple overfeeding — the commonest "cause" once disease is excluded <span style="opacity:.7">(Ettinger Ch 19)</span>']), tone: 'teal' }],
          ],
        },
        ...
        ...stepTable(2, 'BODY-WEIGHT TREND & PHYSIOLOGIC CAUSES', {
          ...
          rows: [
            ...
            ['<strong>Exclude physiologic polyphagia</strong>', { text: bullets(['Growth', 'Pregnancy', 'Lactation', 'Increased exercise', 'Cold environment']), tone: 'teal' }],
            ['<strong>Weight GAIN</strong>', { text: bullets(['Caloric intake exceeds expenditure — psychogenic / behavioural', 'Drug-induced', 'Hyperadrenocorticism / insulinoma']), tone: 'teal' }],
        ...
        ...stepTable(3, 'ASSOCIATED SIGNS & SIGNALMENT', {
          ...
          rows: [
            ['<strong>PU/PD</strong>', { text: bullets(['DM', 'Hyperadrenocorticism', 'Hyperthyroidism — see the PU/PD approach']), tone: 'teal' }],
            ['<strong>GI signs</strong>', { text: bullets(['Large-volume malodorous soft stool → EPI', 'Diarrhoea / melena → IBD', 'Lymphoma', 'Parasites — i.e. malassimilation']), tone: 'teal' }],
            [bullets(['<strong>Senior cat</strong>', '<strong>Weight loss</strong>', '<strong>Hyperactivity ± palpable cervical mass</strong>']), { text: '<strong>Hyperthyroidism</strong> — weight loss 92%, polyphagia 55%', tone: 'teal' }],
      ...
      blocks: [
        ...stepTable(1, 'BODY CONDITION, MUSCLE MASS & HYDRATION', {
          ...
          rows: [
            ...
            ['<strong>Muscle wasting with a good appetite</strong>', { text: bullets(['Catabolic / malabsorptive process — hyperthyroid (77% muscle wasting)', 'DM', 'EPI', 'Lymphoma']), tone: 'teal' }],
        ...
        ...stepTable(2, 'CERVICAL PALPATION & CARDIOVASCULAR (cat)', {
          ...
          rows: [
            ...
            ['<strong>🐱 Auscultation</strong>', { text: bullets(['Tachycardia', 'Murmur']), tone: 'teal' }],
        ...
        ...stepTable(3, 'SKIN, ABDOMEN & CONFORMATION', {
          ...
          rows: [
            [bullets(['<strong>Bilaterally symmetric alopecia / failure to regrow hair</strong>', '<strong>Thin fragile skin</strong>', '<strong>Panting</strong>', '<strong>Comedones</strong>']), { text: '<strong>Hyperadrenocorticism</strong> — feline HAC adds skin fragility and spontaneous tearing', tone: 'teal' }],
            [bullets(['<strong>Broad facial features</strong>', '<strong>Prognathia inferior</strong>', '<strong>Clubbed paws</strong>', '<strong>Abdominal organomegaly</strong>', '<strong>Respiratory stertor / snoring</strong>']), { text: '<strong>Acromegaly</strong> (🐱)', tone: 'teal' }],
            ['<strong>Abdominal palpation</strong>', { text: bullets(['Hepatomegaly (HAC · lymphoma · DM)', 'Thickened bowel or mass (lymphoma · IBD) <span style="opacity:.7">(Ettinger Ch 19)</span>']), tone: 'teal' }],
          ],
        }, '🩺'),
        ...
        ...stepTable(4, 'NEUROLOGIC SCREEN', {
          ...
          headers: ['Finding', { text: 'Points to', tone: 'teal' }],
          rows: [
            [bullets(['<strong>Circling</strong>', '<strong>Blindness</strong>', '<strong>Ataxia</strong>', '<strong>Proprioceptive deficits</strong>', '<strong>Altered mentation</strong>']), { text: 'CNS lesion (infection · neoplasia · trauma) or hepatoencephalopathy (PSS)', tone: 'teal' }],
    ...
    dx: {
      ...
      blocks: [
        { kind: 'step', tone: 'danger', text: '💊 STEP 1 — DRUG / DIET HISTORY + BODY WEIGHT', noArrowAfter: true },
        {
          ...
          rows: [
            ['<strong>Reconcile the medication list</strong>', { text: bullets(['Glucocorticoids', 'Phenobarbital / KBr', 'Benzodiazepines', 'Antihistamines', 'Progestins']), tone: 'danger' }],
        ...
        ...stepTable(2, 'MINIMUM DATABASE + GLUCOSE / FRUCTOSAMINE + T4 (cat)', {
          ...
          rows: [
            [bullets(['<strong>CBC</strong>', '<strong>Serum chemistry</strong>', '<strong>Urinalysis</strong>']), { text: 'Add <strong>TT4 in every senior cat</strong>', tone: 'teal' }],
            ['<strong>Blood glucose ± glucosuria</strong>', { text: bullets(['<strong>Diabetes:</strong> 🐕 random BG ≥200 mg/dL (≥11 mmol/L) with classic signs', '🐱 Random BG ≥270 mg/dL (≥15 mmol/L) with signs + glucosuria on ≥2 home samples (stress hyperglycaemia caveat)']), tone: 'teal' }],
            ['<strong>Fructosamine</strong>', { text: bullets(['Confirms persistent hyperglycaemia (DM)', 'When <em>low</em>, supports insulinoma — but it is reduced by hyperthyroidism and acromegaly']), tone: 'teal' }],
        ...
        ...stepTable(3, 'IF WEIGHT LOSS: GI / MALABSORPTION PANEL', {
          ...
          headers: ['Test', { text: 'Interpretation', tone: 'teal' }],
          rows: [
            ['<strong>Serum TLI (fasted)</strong> — test of choice for EPI', { text: bullets(['Canine cutoff <strong>&lt;2.5 µg/L</strong>', 'Feline cutoff <strong>&lt;8.0 µg/L</strong>']), tone: 'teal' }],
            ['<strong>Cobalamin (B12) + folate</strong>', { text: bullets(['Assess intestinal malabsorption — hypocobalaminaemia in 82% of dogs / 77% of cats with EPI, and common in IBD / lymphoma', 'Supplement if &lt;400 ng/L']), tone: 'teal' }],
            ['<strong>Abdominal ultrasound ± endoscopy / biopsy</strong>', { text: bullets(['Infiltrative bowel disease vs alimentary lymphoma', 'Recheck a faecal for parasites <span style="opacity:.7">(Ettinger Ch 19, 279)</span>']), tone: 'teal' }],
          ],
        }, '🦠'),
        ...
        ...stepTable(4, 'IF WEIGHT GAIN: HAC TESTING & IGF-1', {
          ...
          rows: [
            ['<strong>Hyperadrenocorticism</strong>', { text: bullets(['Screen with the <strong>LDDS test</strong> (low-dose dexamethasone suppression) or <strong>ACTH-stimulation test</strong> once non-adrenal illness is controlled', 'Ultrasound and urine cortisol:creatinine support']), tone: 'teal' }],
            ['<strong>🐱 Acromegaly</strong>', { text: bullets(['Serum <strong>IGF-1 ≥1000 ng/mL</strong> (≥131 nmol/L) has ≥95% positive predictive value in diabetic cats — screen every newly diagnosed diabetic cat', 'Confirm with pituitary CT / MRI <span style="opacity:.7">(Ettinger Ch 19, 280, 293–294)</span>']), tone: 'teal' }],
          ],
        }, '📈'),
        ...
        ...stepTable(5, 'IF HYPOGLYCAEMIC: INSULINOMA WORK-UP', {
          ...
          rows: [
            ['<strong>Confirm fasting hypoglycaemia</strong>', { text: bullets(['Blood glucose <strong>&lt;60 mg/dL (&lt;3.3 mmol/L)</strong> with <strong>normo- or hyperinsulinaemia</strong> (serum insulin within or above reference despite the low glucose) is the biochemical hallmark', 'Most dogs become hypoglycaemic within 12 h of a meal under supervised fast']), tone: 'teal' }],
            ['<strong>Do NOT use</strong>', { text: bullets(['The amended insulin:glucose ratio is <strong>not sensitive and not recommended</strong>', 'Tolerance / stimulation tests are dangerous']), tone: 'danger' }],
