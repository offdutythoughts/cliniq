    ...
    history: {
      ...
      blocks: [
        { kind: 'goal', text: 'GOAL: INFLAMMATORY vs NON-INFLAMMATORY · MONO- vs POLY-' },
        {
          ...
          rows: [
            ['<strong>Degenerative (DJD / OA)</strong>', { text: bullets(['Intermittent or shifting lameness in an otherwise healthy animal', 'Few joints', 'Larger proximal joints']), tone: 'teal' }],
            ['<strong>Inflammatory joint disease</strong>', { text: bullets(['Often <strong>not obviously lame</strong> — lethargy', '↓ Appetite', '<strong>Fever</strong>; many joints, with the <strong>distal joints (carpi · tarsi)</strong> favoured in immune-mediated disease']), tone: 'teal' }],
          ],
        },
        ...
        { kind: 'step', tone: 'danger', text: '🚨 STEP 1 — IS A SINGLE HOT JOINT SEPTIC?', noArrowAfter: true },
        {
          ...
          rows: [
            ...
            ['<strong>Typical site</strong>', { text: bullets(['A large proximal joint — stifle', 'Elbow', 'Shoulder', 'Hip <span style="opacity:.7">(Ettinger Ch 32 / Ch 177)</span>']), tone: 'teal' }],
          ],
        },
        ...
        ...stepTable(2, 'SIGNALMENT & BREED CLUES', {
          ...
          rows: [
            ...
            ['<strong>Shar-Pei</strong>', { text: bullets(['Familial Shar-Pei fever — 12–48 h bouts of fever + swollen hocks', 'Colchicine to reduce amyloidosis risk']), tone: 'teal' }],
            ['<strong>Akita</strong>', { text: 'Severe juvenile-onset polyarthropathy', tone: 'teal' }],
            [bullets(['<strong>Greyhound</strong>', '<strong>Border Collie</strong>']), { text: 'Erosive disease', tone: 'teal' }],
        ...
        ...stepTable(3, 'DRUGS, VACCINES & A DISTANT FOCUS (reactive)', {
          ...
          rows: [
            ['<strong>Drugs</strong>', { text: bullets(['Trimethoprim-sulfonamide (especially Doberman Pinschers)', 'Penicillins', 'Cephalosporins']), tone: 'teal' }],
            ['<strong>Recent vaccination</strong>', { text: bullets(['Canine distemper', 'Lyme — typically within 1–2 weeks']), tone: 'teal' }],
            ['<strong>A distant inflammatory / infectious / neoplastic focus</strong>', { text: bullets(['Chronic infection (deep mycoses · discospondylitis · endocarditis)', 'GI inflammation (enteropathic polyarthropathy)', 'Distant neoplasia (particularly haemic) <span style="opacity:.7">(Ettinger Ch 32 / Ch 177)</span>']), tone: 'teal' }],
          ],
        }, '💊'),
        ...
        ...stepTable(4, 'TRAVEL, TICKS & GEOGRAPHY', {
          ...
          rows: [
            [bullets(['<strong>Tick exposure</strong>', '<strong>Preventive history</strong>', '<strong>Geography</strong>', '<strong>Travel</strong>']), { text: 'Vector-borne polyarthritis is common <em>and treatable</em>', tone: 'teal' }],
            ['<strong>Regional agents</strong>', { text: bullets(['<strong>Lyme (Borrelia)</strong>', 'Anaplasma', 'Ehrlichia', '<strong>RMSF (Rickettsia)</strong>', 'Leishmania', 'Systemic mycoses (coccidioidomycosis · blastomycosis) where endemic']), tone: 'teal' }],
    ...
    exam: {
      ...
      blocks: [
        ...
        ...stepTable(1, 'PALPATE EVERY JOINT (not just the swollen one)', {
          ...
          rows: [
            ['<strong>Systematically flex / extend and palpate ALL appendicular joints</strong>', { text: bullets(['Swelling', 'Effusion', 'Heat', 'Pain', 'Crepitus', 'Instability — <strong>a polyarthropathy can hide in joints that look and feel normal</strong>']), tone: 'danger' }],
        ...
        ...stepTable(2, 'SYSTEMIC SIGNS OF INFLAMMATORY DISEASE', {
          ...
          rows: [
            [bullets(['<strong>Fever</strong>', '<strong>Lethargy</strong>', '<strong>Inappetence</strong>']), { text: 'Accompany inflammatory joint disease far more than degenerative disease', tone: 'teal' }],
        ...
        ...stepTable(3, 'HUNT FOR A SOURCE / MULTISYSTEM DISEASE', {
          ...
          rows: [
            ...
            [bullets(['<strong>Skin / mucocutaneous lesions</strong>', '<strong>Oral ulcers</strong>']), { text: bullets(['SLE', 'Leishmaniosis']), tone: 'teal' }],
            ['<strong>Fundic exam</strong>', { text: bullets(['Chorioretinitis / retinal change with systemic hypertension', 'Fungal or vector-borne disease <span style="opacity:.7">(Ettinger Ch 32)</span>']), tone: 'teal' }],
          ],
        }, '🔍'),
      ...
      blocks: [
        { kind: 'step', tone: 'teal', text: '💉 STEP 1 — ARTHROCENTESIS + SYNOVIAL CYTOLOGY/CULTURE (the cornerstone)', noArrowAfter: true },
        {
          ...
          rows: [
            ...
            ['<strong>Sample handling</strong>', { text: bullets(['Individual slides for <strong>cytology per joint</strong>', '<strong>Pool the remainder for culture</strong> — place synovial fluid in blood-culture medium to boost sensitivity']), tone: 'teal' }],
            ['<strong>Volume</strong>', { text: bullets(['Small — &lt;0.2 mL is common', 'Slides alone suffice']), tone: 'teal' }],
          ],
        },
        {
          kind: 'gridTable',
          ...
          rows: [
            ['<strong>Normal</strong>', { text: bullets(['TNCC &lt;3 ×10⁹/L', 'TP &lt;25 g/L', '&gt;95% mononuclear', '<strong>&lt;5–10% neutrophils</strong>', 'High viscosity (strings 3–5 cm)']), tone: 'teal' }],
            ['<strong>DJD / non-inflammatory</strong>', { text: bullets(['TNCC &lt;5 ×10⁹/L', 'Mononuclear', '&lt;10% neutrophils']), tone: 'teal' }],
            ['<strong>Inflammatory (IJD)</strong>', { text: bullets(['<strong>TNCC &gt;5 ×10⁹/L</strong> (often 40,000–250,000/µL)', '<strong>&gt;10% — usually &gt;60–90% — neutrophils</strong>']), tone: 'teal' }],
            ['<strong>Septic</strong>', { text: bullets(['Degenerate neutrophils ± intracellular bacteria', 'Culture POSITIVE — but sensitive in only <strong>44–63%</strong>, so <strong>culture-negative does NOT exclude sepsis</strong>']), tone: 'danger' }],
            ['<strong>Immune-mediated</strong>', { text: bullets(['High neutrophil counts that are <strong>culture-negative</strong> and non-degenerate ± ragocytes', 'LE cells <span style="opacity:.7">(Ettinger Ch 32 / Ch 71 / Ch 87)</span>']), tone: 'teal' }],
          ],
        },
        ...
        ...stepTable(2, 'RADIOGRAPHS (erosive vs non-erosive · OA · bone tumour)', {
          ...
          rows: [
            ...
            ['<strong>Erosive</strong>', { text: bullets(['Subchondral bone lysis ± periosteal proliferation — rheumatoid arthritis', 'Feline periosteal proliferative']), tone: 'teal' }],
        ...
        ...stepTable(3, 'CBC / CHEM / UA + HUNT THE FOCUS', {
          ...
          rows: [
            ['<strong>CBC</strong>', { text: bullets(['Mild non-regenerative anaemia and mild leukocytosis are common', '<strong>Thrombocytopenia</strong> prompts testing for tick-borne organisms or concurrent ITP']), tone: 'teal' }],
            ['<strong>Chemistry</strong>', { text: bullets(['Marked liver-enzyme elevation may signal a distant inflammatory stimulus', 'Hyperglobulinaemia suggests ehrlichiosis / leishmaniosis']), tone: 'teal' }],
            ['<strong>Urinalysis with culture</strong>', { text: 'Occult UTI as a focus', tone: 'teal' }],
            ['<strong>Source-hunt</strong>', { text: bullets(['Thoracic + abdominal imaging (occult neoplasia / infection)', 'Blood + urine cultures', 'Echocardiogram if bacteraemia or endocarditis suspected', 'Vertebral radiographs for discospondylitis', 'CSF analysis if SRMA is concurrent']), tone: 'teal' }],
        ...
        ...stepTable(4, 'VECTOR-BORNE SEROLOGY / PCR BY GEOGRAPHY', {
          ...
          rows: [
            ['<strong>Regionally relevant agents</strong>', { text: bullets(['<em>Ehrlichia canis</em>', '<em>Borrelia burgdorferi</em>', '<em>Anaplasma phagocytophilum</em>', 'RMSF (Rickettsia)', 'Leishmania', 'Systemic mycoses — serology and/or PCR, guided by geography and travel']), tone: 'teal' }],
            ...
            ['<strong>Morulae in neutrophils</strong>', { text: bullets(['On synovial / blood smears — Anaplasma', '<em>E. ewingii</em>']), tone: 'teal' }],
        ...
        ...stepTable(5, 'ANA / RF (interpret cautiously)', {
          ...
          rows: [
            ...
            ['<strong>Use them as</strong>', { text: bullets(['Findings that <em>bolster</em> suspicion, never stand-alone confirmation', 'Idiopathic / primary IMPA remains a <strong>diagnosis of exclusion</strong> after ruling out infection, reactive causes and neoplasia <span style="opacity:.7">(Ettinger Ch 32 / Ch 177)</span>']), tone: 'teal' }],
          ],
        }, '🔬'),
        ...
        ...stepTable(6, 'ANTIBIOTIC-THEN-IMMUNOSUPPRESSION DECISION', {
          ...
          rows: [
            ['<strong>Screen for infection BEFORE immunosuppressing</strong>', { text: bullets(['If septic or vector-borne disease is possible, treat the infection first — lavage + antimicrobials for septic arthritis', '<strong>Doxycycline trial</strong> for suspected vector-borne polyarthritis. Culture / serotest and treat empirically while awaiting results']), tone: 'danger' }],
            ...
            ['<strong>Steroid-sparing agents</strong>', { text: bullets(['<strong>Mycophenolate 10 mg/kg PO q12h</strong>', 'Leflunomide', 'Ciclosporin — for relapse or to spare steroids']), tone: 'teal' }],
            ['<strong>NSAID washout</strong>', { text: '~7 days before steroids — <strong>high GI-ulcer risk if overlapped</strong>', tone: 'danger' }],
            ['<strong>Prognosis</strong>', { text: bullets(['~90% of IMPA respond rapidly', 'Many relapse and some need lifelong therapy <span style="opacity:.7">(Ettinger Ch 177)</span>']), tone: 'teal' }],
          ],
        }, '💊'),
      ],
      after: [
