      ...
      blocks: [
        { kind: 'goal', text: 'GOAL: TREMOR vs SEIZURE, THEN TRIAGE THE CAUSE' },
        {
          ...
          rows: [
            ...
            ['<strong>Seizure</strong>', { text: bullets(['Impaired consciousness', 'Increased tone', 'Autonomic signs (salivation · incontinence) → switch to the <strong>Seizures</strong> approach']), tone: 'danger' }],
          ],
        },
        ...
        { kind: 'step', tone: 'danger', text: '☠️ STEP 1 — TOXIN / EXPOSURE HISTORY (ask first)', noArrowAfter: true },
        {
          ...
          rows: [
            ['<strong>Tremorgenic mycotoxins</strong>', { text: bullets(['Access to mouldy food', 'Compost', 'Bins', 'Fallen nuts (penitrem A / roquefortine) — the <strong>commonest cause of acute generalised tremor</strong>']), tone: 'danger' }],
            ...
            ['<strong>Lead</strong>', { text: bullets(['Old paint', 'Linoleum', 'Weights', 'Toys']), tone: 'teal' }],
            ['<strong>Methylxanthines</strong>', { text: bullets(['Chocolate / caffeine', 'Also xylitol', 'Bromethalin', 'Cannabis', 'Macadamia']), tone: 'teal' }],
            ...
            ['<strong>Drugs / withdrawal</strong>', { text: bullets(['Metronidazole', '5-HT drugs / SSRIs', 'Macrocyclic lactones']), tone: 'teal' }],
          ],
        },
        ...
        ...stepTable(2, 'SIGNALMENT & ONSET PATTERN', {
          ...
          rows: [
            [bullets(['<strong>Young adult small / white dog</strong>', '<strong>Fine whole-body tremor</strong>', '<strong>Otherwise well</strong>']), { text: '<strong>Idiopathic generalised tremor syndrome (IGTS, "white-shaker")</strong> — occurs in any breed but is rare in dogs &gt;20 kg', tone: 'teal' }],
            ['<strong>Puppy / kitten tremoring from ~10 days of age when aroused</strong>', { text: bullets(['<strong>Hypomyelination</strong> ("shaker pup") — Springer', 'Weimaraner', 'Chow', 'Samoyed', 'Siamese cats. Many recover by ~5 months']), tone: 'teal' }],
            ['<strong>Lactating bitch / late-pregnancy or post-whelping</strong>', { text: '<strong>Eclampsia</strong> (hypocalcaemia)', tone: 'danger' }],
            [bullets(['<strong>Toy-breed puppy</strong>', '<strong>Juvenile</strong>', '<strong>Older dog with fasting or exertional episodes</strong>']), { text: '<strong>Hypoglycaemia</strong> — including insulinoma in an older dog', tone: 'teal' }],
        ...
        ...stepTable(3, 'TRIGGERS, COURSE & WHAT MAKES IT WORSE', {
          ...
          rows: [
            ...
            ['<strong>Worse with anxiety / excitement, better at rest or sleep</strong>', { text: bullets(['IGTS', 'Idiopathic head tremor']), tone: 'teal' }],
      ...
      blocks: [
        { kind: 'step', tone: 'teal', text: ' A complete PE first — TEMPERATURE, heart rate & mucous membranes', noArrowAfter: true },
        {
          ...
          rows: [
            ...
            [bullets(['<strong>Tachycardia</strong>', '<strong>Mydriasis</strong>']), { text: 'Intoxication — muscle relaxation is a treatment target', tone: 'danger' }],
            [bullets(['<strong>GI signs</strong>', '<strong>Hyperaesthesia</strong>']), { text: 'Note and record', tone: 'teal' }],
          ],
        },
        ...
        ...stepTable(1, 'CHARACTERISE THE TREMOR', {
          ...
          rows: [
            ['<strong>Where &amp; when?</strong>', { text: bullets(['Whole-body vs head-only vs limb / trunk', 'At <strong>rest</strong> (uncommon — toxic / drug) vs <strong>action</strong>']), tone: 'teal' }],
            ['<strong>Action tremor subtypes</strong>', { text: bullets(['Postural (holding against gravity)', 'Kinetic-simple (throughout movement)', '<strong>Kinetic-intention</strong> (crescendos toward a target — cerebellar)', 'Orthostatic (only when standing)']), tone: 'teal' }],
        ...
        ...stepTable(2, 'FOCUSED NEUROLOGICAL EXAM (localise)', {
          ...
          rows: [
            ...
            [bullets(['<strong>Multifocal / asymmetric signs</strong>', '<strong>Mentation change</strong>', '<strong>Cervical pain in a young small-breed dog</strong>']), { text: '<strong>MUO / GME</strong>', tone: 'danger' }],
        ...
        ...stepTable(3, 'SCREEN FOR METABOLIC CLUES', {
          ...
          rows: [
            ['<strong>Weakness / cervical ventroflexion</strong>', { text: bullets(['Hypokalaemia', 'Hypocalcaemia']), tone: 'teal' }],
      ...
      blocks: [
        { kind: 'step', tone: 'danger', text: '⚡ STEP 1 — IF ACUTE & HYPERTHERMIC, STABILISE FIRST', noArrowAfter: true },
        {
          ...
          rows: [
            ...
            ['<strong>Control the tremors</strong>', { text: bullets(['<strong>Methocarbamol 40–50 mg/kg slow IV</strong> to effect, then 8.8–12.2 mg/kg/h CRI (<strong>do not exceed 330 mg/kg/day</strong>)', 'Dexmedetomidine', 'Phenobarbital / levetiracetam', 'Ketamine as needed']), tone: 'danger' }],
            ['<strong>Decontaminate</strong>', { text: bullets(['Emesis only if conscious — apomorphine 20–40 µg/kg IV', 'Activated charcoal 0.5–4 g/kg', '<strong>Bathe</strong> for dermal permethrin']), tone: 'danger' }],
        ...
        ...stepTable(2, 'METABOLIC PANEL (rule out the reversible causes)', {
          ...
          rows: [
            ['<strong>Ionised calcium</strong>', { text: bullets(['Eclampsia', 'Hypoparathyroidism — <strong>total calcium is unreliable</strong>; correct for albumin or, better, measure ionised']), tone: 'teal' }],
            ['<strong>Blood glucose</strong>', { text: bullets(['Hypoglycaemia — insulinoma', 'Sepsis', 'Toy-breed / neonate', 'Hepatic failure. If low, run paired insulin on the <strong>same sample</strong>']), tone: 'teal' }],
        ...
        ...stepTable(4, 'ADVANCED IMAGING (cerebellar / inflammatory disease)', {
          ...
          rows: [
            ...
            ['<strong>Cerebellar abiotrophy / degeneration</strong>', { text: bullets(['Cerebellar atrophy on MRI', 'Normal-to-unremarkable CSF']), tone: 'teal' }],
            ['<strong>Cerebellar hypoplasia</strong>', { text: bullets(['Small cerebellum', 'Non-progressive history from first ambulation (FPV in kittens)']), tone: 'teal' }],
            ['<strong>MUO / GME</strong>', { text: bullets(['Multifocal T2 / FLAIR hyperintensities ± enhancement', 'CSF mononuclear or mixed pleocytosis with raised protein. Run an <strong>infectious panel to exclude infection BEFORE immunosuppressing</strong>']), tone: 'danger' }],
        ...
        ...stepTable(5, 'IDIOPATHIC GENERALISED TREMOR (steroid-response test)', {
          ...
          rows: [
            ['<strong>When to diagnose</strong>', { text: bullets(['Toxic, metabolic, structural and inflammatory causes excluded — young dog', 'Fine whole-body tremor worse with anxiety', '<strong>Normal MRI</strong>', 'Normal-to-mild mononuclear / lymphocytic CSF pleocytosis']), tone: 'teal' }],
