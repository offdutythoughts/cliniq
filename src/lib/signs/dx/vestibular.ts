  ...
  exam: {
    ...
    blocks: [
      ...
      // only earns its place if it can be found in one glance.
      {
        ...
        rows: [
          ['<strong>Gait</strong>', '• Rolling / falling direction<br>• Circling<br>• Ataxia', { text: 'Falls and rolls <strong>toward</strong> the lesion in most cases', tone: 'teal' }],
          ['<strong>Head tilt</strong>', 'Which ear is held lower', { text: '• <strong>Toward</strong> lesion → peripheral <em>or</em> central<br>• <strong>Away</strong> → paradoxical — cerebellum / caudal peduncle', tone: 'teal' }],
          ['<strong>Nystagmus</strong><br>1 · is it pathological?', 'Watch the eyes:<br>• Head still<br>• Head held up<br>• In dorsal recumbency', { text: '• Only while the head <em>moves</em> → physiological, normal<br>• At rest → pathological<br>• <strong>Spontaneous</strong> — normal head position<br>• <strong>Positional</strong> — only in certain positions', tone: 'teal' }],
          ['<strong>Nystagmus</strong><br>2 · jerk or pendular?', '• <strong>Jerk</strong> — slow drift, then a quick flick<br>• <strong>Pendular</strong> — continuous to-and-fro, no fast phase', { text: '• <strong>Jerk</strong> → vestibular, characterise it in points 3–5 below<br>• <strong>Pendular</strong> → <strong>not</strong> vestibular<br>• Congenital visual-pathway anomaly (Siamese · Birman · Himalayan · Belgian Shepherd)', tone: 'teal' }],
          ...
          ['<strong>Jerk nystagmus</strong><br>4 · fast phase', 'Name it by the <strong>flick</strong> — the direction the quick phase beats', { text: '• Slow phase is pathological — drifts <strong>toward</strong> the lesion, with the head tilt<br>• Fast phase is corrective — beats <strong>away</strong><br>• Sides the lesion if peripheral<br>• <strong>Unreliable if central</strong> — may beat either way', tone: 'teal' }],
