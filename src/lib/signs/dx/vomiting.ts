...
export const vomitingDx: DxApproach = {
  ...
  history: {
    ...
    <div style="display:grid;grid-template-columns:1.2fr 1fr 1fr;gap:5px 8px;font-size:10.5px;line-height:1.4;"><div style="font-weight:700;padding-bottom:4px;border-bottom:1px solid rgba(148,163,184,.25);">Feature</div><div style="font-weight:700;padding-bottom:4px;border-bottom:1px solid rgba(148,163,184,.25);color:#FCA5A5;">Vomiting</div><div style="font-weight:700;padding-bottom:4px;border-bottom:1px solid rgba(148,163,184,.25);color:#6EE7B7;">Regurgitation</div><div>Retching?</div><div style="color:#FCA5A5;">Usually present</div><div style="color:#6EE7B7;">Usually absent</div><div>Abdominal effort?</div><div style="color:#FCA5A5;">Active</div><div style="color:#6EE7B7;">Passive — none</div><div>Prodromal nausea?</div><div style="color:#FCA5A5;">Lip licking, ptyalism</div><div style="color:#6EE7B7;">Absent</div><div>Bile present?</div><div style="color:#FCA5A5;">May be present</div><div style="color:#6EE7B7;">Usually absent</div><div>Ingesta digested?</div><div style="color:#FCA5A5;">May be digested</div><div style="color:#6EE7B7;">Typically undigested, tubular</div><div>Timing after eating?</div><div style="color:#FCA5A5;">Variable</div><div style="color:#6EE7B7;">Any time; soon after ↑ suspicion</div><div>White/clear mucus?</div><div style="color:#FCA5A5;">Less typical</div><div style="color:#6EE7B7;">Frothy saliva common</div><div>Frequency?</div><div style="color:#FCA5A5;">Variable</div><div style="color:#6EE7B7;">Many/day, no systemic signs</div><div>Duration?</div><div style="color:#FCA5A5;">Variable</div><div style="color:#6EE7B7;">Weeks–months (megaoesoph.); acute if obstructive</div></div>
    <div style="margin-top:8px;font-size:10px;opacity:.75;">⚠️ If uncertain, work up as vomiting. If vomiting workup yields no diagnosis, pursue oesophageal investigation. Owner video is very helpful.</div>
      ...
      {
        kind: 'check',
        html: `<strong style="color:#6EE7B7;">Acute vomiting (&lt;7 days)</strong><br>
    ...
    <span style="font-size:10px;opacity:.75;">Many acute cases are self-limiting. Red flags require urgent workup.</span>`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#FCD34D;">Chronic vomiting (&gt;7 days)</strong><br>
    ...
    <span style="font-size:10px;opacity:.75;">Requires systematic minimum database + targeted second-tier diagnostics.</span>`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#FCA5A5;">Blood (haematemesis)</strong><br>
    ...
    • Swallowed blood from nasal/oral/pulmonary source can mimic haematemesis`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#FCD34D;">Bile</strong><br>
    ...
    • Bilious vomiting syndrome: small amounts of bile after prolonged fasting → duodenogastric reflux (end of fasting window)`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#6EE7B7;">Undigested / partially digested food</strong><br>
    ...
    • Intact female: pyometra — always consider if not neutered`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#93C5FD;">Drug / toxin / vaccination history</strong><br>
  ...
  exam: {
    ...
    • Bradycardia → hypoadrenocorticism (hyperkalaemia), severe vagal response`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#6EE7B7;">Mucous Membranes</strong><br>
    ...
    <span style="font-size:10px;opacity:.75;">⚠️ GDV: large breed dog + tympanic abdomen + non-productive retching → emergency — do not delay.</span>`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#FCA5A5;">Oral Cavity</strong><br>
    ...
    • Halitosis → uraemia, hepatic encephalopathy, oral disease`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#FCD34D;">Neck + Thyroid</strong><br>
    ...
    • Submandibular lymphadenopathy → neoplasia, infection, lymphoma`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#C4B5FD;">Neurological Assessment</strong><br>
    ...
    <span style="font-size:10px;opacity:.75;">Primary CNS disease causing vomiting alone (without other neurological signs) is rare.</span>`,
      ...
      {
        kind: 'check',
        html: `<strong style="color:#FCA5A5;">Rectal Examination</strong><br>
