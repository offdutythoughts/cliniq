      ...
      columns: [
        {
          ...
          tone: 'orange',
          tiles: [
            { label: 'Periodontal disease / tooth-root abscess' },
            { label: 'Oronasal fistula', link: { to: 'disease', id: 'DIS-DENT-ORONASAL' } },
            { label: 'Stomatitis / FCGS (cat)' },
            { label: 'Oral foreign body' },
            { label: 'Jaw fracture / TMJ luxation' },
            { label: 'Retrobulbar abscess / mass' },
          ],
        },
        {
          cat: 'Neoplastic',
          tone: 'violet',
          tiles: [
            { label: 'Oral melanoma 🐕 (#1 dog)' },
            { label: 'Squamous cell carcinoma 🐈 (#1 cat, #2 dog)' },
            { label: 'Fibrosarcoma 🐕 (#3 dog)' },
            { label: 'Acanthomatous ameloblastoma 🐕' },
        ...
        },
        {
          ...
          tone: 'neutral',
          tiles: [
            { label: 'Masticatory muscle myositis (MMM)' },
            { label: 'Trigeminal neuropathy / neuritis' },
            { label: 'Craniomandibular osteopathy (CMO) 🐕' },
            { label: 'Polymyositis', link: { to: 'disease', id: 'DIS-NEU-POLYMYOSITIS' } },
            { label: 'Botulism / tetanus 🐕' },
            { label: 'Pharyngeal / cricopharyngeal dysphagia' },
          ],
        },
        {
          cat: 'Oesophageal',
          ...
          tiles: [
            ...
            { label: 'Oesophageal stricture (post-GA / doxycycline)' },
            { label: 'Oesophagitis (GA-induced GOR)' },
            { label: 'Vascular ring anomaly / PRAA 🐕' },
            { label: 'Cricopharyngeal dysphagia' },
          ],
        },
      ],
    },
