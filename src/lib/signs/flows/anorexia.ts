    ...
    { kind: 'node', variant: 'step', text: 'IDENTIFY LESION CATEGORY' },
    {
      ...
      columns: [
        ...
        },
        {
          ...
          tone: 'violet',
          tiles: [
            { label: 'Oral melanoma 🐕 (#1 dog)', link: { to: 'disease', id: 'DIS-NEO-ORAL-MEL' } },
            { label: 'Squamous cell carcinoma 🐈 (#1 cat, #2 dog)', link: { to: 'disease', id: 'DIS-NEO-ORAL-SCC' } },
            { label: 'Fibrosarcoma 🐕 (#3 dog)', link: { to: 'disease', id: 'DIS-NEO-ORAL-FSA' } },
            { label: 'Acanthomatous ameloblastoma 🐕', link: { to: 'disease', id: 'DIS-NEO-ORAL-AME' } },
        ...
        },
        {
          ...
          tiles: [
            ...
            { label: 'Craniomandibular osteopathy (CMO) 🐕', link: { to: 'disease', id: 'DIS-NEU-CMO' } },
            { label: 'Polymyositis', link: { to: 'disease', id: 'DIS-NEU-POLYMYOSITIS' } },
            { label: 'Botulism 🐕', link: { to: 'disease', id: 'DIS-NEU-BOTULISM' } },
            { label: 'Tetanus 🐕', link: { to: 'disease', id: 'DIS-NEU-TETANUS' } },
