          ...
          blocks: [
            {
              kind: 'endpoints',
              items: [
                { label: 'CRGV / Alabama rot', tone: 'danger', link: { to: 'disease', id: 'DIS-BD-CRGV' } },
                { label: 'Cutaneous vasculitis', tone: 'violet', link: { to: 'disease', id: 'DIS-BD-VASC' } },
                { label: 'Lhasa Apso vasculopathy', tone: 'neutral', link: { to: 'disease', id: 'DIS-BD-VASCLH' } },
              ],
            },
          ],
        },
          ...
          blocks: [
            {
              ...
              items: [
                ...
                { label: 'RMSF', tone: 'danger', link: { to: 'disease', id: 'DIS-INFECT-RMSF' } },
                { label: 'Leishmaniasis', tone: 'green', link: { to: 'disease', id: 'DIS-INFECT-LEISHM' } },
                { label: 'Leptospirosis', tone: 'warning', link: { to: 'disease', id: 'DIS-INFECT-LEPTO' } },
                { label: 'FIP', tone: 'neutral', link: { to: 'disease', id: 'DIS-INFECT-FIP' } },
              ],
            },
          ],
        },
          ...
          blocks: [
            {
              kind: 'endpoints',
              items: [
                { label: 'Hypertension', tone: 'danger', link: { to: 'disease', id: 'DIS-VASC-HYPERT' } },
                { label: 'Hyperviscosity', tone: 'violet', link: { to: 'disease', id: 'DIS-VASC-HYPERVSC' } },
                { label: 'HAC / steroids', tone: 'warning', link: { to: 'disease', id: 'DIS-PUPD-HAC' } },
                { label: 'Uraemic vasculopathy', tone: 'neutral', link: { to: 'disease', id: 'DIS-SEC-CKD' } },
              ],
            },
          ],
        },
      ...
      columns: [
        {
          ...
          blocks: [{ kind: 'endpoints', items: [
            { label: 'Lymphoma', tone: 'danger', link: { to: 'disease', id: 'DIS-NEO-LSA' } },
            { label: 'Leukaemia', tone: 'danger', link: { to: 'disease', id: 'DIS-NEO-LEUK' } },
            { label: 'Multiple myeloma', tone: 'danger', link: { to: 'disease', id: 'DIS-NEO-MM' } },
            { label: 'Immune-mediated aplasia', tone: 'danger', link: { to: 'disease', id: 'DIS-BD-NRA' } },
            { label: 'Myelofibrosis / myelophthisis', tone: 'danger', link: { to: 'disease', id: 'DIS-BD-NRA' } },
          ]}],
        },
        {
          header: 'Drug-induced',
          tone: 'warning',
          blocks: [{ kind: 'endpoints', items: [
            { label: 'Cytotoxic chemotherapy', tone: 'warning' },
            { label: 'Chloramphenicol', tone: 'warning' },
            { label: 'Oestrogen', tone: 'warning' },
          ]}],
        },
        {
          ...
          tone: 'danger',
          blocks: [{ kind: 'endpoints', items: [
            { label: 'FeLV', tone: 'neutral', link: { to: 'disease', id: 'DIS-INFECT-FELV' } },
            { label: 'Ehrlichiosis', tone: 'orange', link: { to: 'disease', id: 'DIS-BD-EHRL' } },
            { label: 'Hypothyroidism', tone: 'neutral', link: { to: 'disease', id: 'DIS-ENDO-HYPOTHY' } },
          ]}],
        },
      ],
    },
      ...
      columns: [
        {
          ...
          tone: 'danger',
          blocks: [{ kind: 'endpoints', items: [
            { label: 'Significant haemorrhage', tone: 'danger' },
            { label: 'Sepsis', tone: 'danger', link: { to: 'disease', id: 'DIS-SHOCK-SEPTIC' } },
            { label: 'Vasculitis', tone: 'danger', link: { to: 'disease', id: 'DIS-BD-VASC' } },
            { label: 'DIC', link: { to: 'disease', id: 'DIS-BD-DIC' }, tone: 'danger' },
          ]}],
        },
        {
          ...
          tone: 'warning',
          blocks: [{ kind: 'endpoints', items: [
            { label: 'Splenomegaly', tone: 'warning', link: { to: 'disease', id: 'DIS-SPLEEN' } },
          ]}],
        },
      ],
    },
      ...
      columns: [
        {
          ...
          tone: 'danger',
          blocks: [{ kind: 'endpoints', items: [
            { label: 'Primary IMTP', link: { to: 'disease', id: 'DIS-BD-IMTP' }, sublabel: '#1 cause dog', tone: 'danger' },
            { label: 'Secondary immune-mediated', tone: 'warning' },
          ]}],
        },
        {
          header: 'Drug-induced',
          tone: 'warning',
          blocks: [{ kind: 'endpoints', items: [
            { label: 'Drug-induced thrombocytopenia', tone: 'warning' },
          ]}],
        },
        {
          header: 'Infectious',
