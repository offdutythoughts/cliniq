...
const blindEyeAcute: FlowPage = {
  ...
  blocks: [
...

    {
      ...
      size: 10,
      items: [
        { variant: 'insp', label: 'Anterior opacity', link: { to: 'lesion', loc: 'LOC-BL-OPAQUE', name: 'Anterior segment opacity', filter: 'acute' } },
        { variant: 'exp', label: 'Retina', link: { to: 'lesion', loc: 'LOC-BL-RETINA', name: 'Retinal disease', filter: 'acute' } },
        { variant: 'rest', label: 'Optic nerve', link: { to: 'lesion', loc: 'LOC-BL-OPTIC', name: 'Optic nerve', filter: 'acute' } },
        { variant: 'insp', tone: 'purple', label: 'Cortex / forebrain', link: { to: 'lesion', loc: 'LOC-BL-CORTEX', name: 'Cortical / forebrain', filter: 'acute' } },
      ],
      connectAfter: false,
    },
...
const blindEyeChronic: FlowPage = {
  ...
  blocks: [
...

    {
      ...
      size: 10,
      items: [
        { variant: 'insp', label: 'Anterior opacity', link: { to: 'lesion', loc: 'LOC-BL-OPAQUE', name: 'Anterior segment opacity', filter: 'chronic' } },
        { variant: 'exp', label: 'Retina', link: { to: 'lesion', loc: 'LOC-BL-RETINA', name: 'Retinal disease', filter: 'chronic' } },
        { variant: 'rest', label: 'Optic nerve', link: { to: 'lesion', loc: 'LOC-BL-OPTIC', name: 'Optic nerve', filter: 'chronic' } },
        { variant: 'mixed', label: 'Chiasm / tract', link: { to: 'lesion', loc: 'LOC-BL-CHIASM', name: 'Chiasm / optic tract', filter: 'chronic' } },
        { variant: 'insp', tone: 'purple', label: 'Cortex / forebrain', link: { to: 'lesion', loc: 'LOC-BL-CORTEX', name: 'Cortical / forebrain', filter: 'chronic' } },
      ],
      connectAfter: false,
    },
