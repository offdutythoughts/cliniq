      ...
      columns: [
        {
          ...
          tone: 'orange',
          tiles: [
            { label: '🌬️ UPPER-AIRWAY OBSTRUCTION', link: { to: 'disease', id: 'DIS-RESP-BOAS' } },
            { label: '🗣️ LARYNGEAL PARALYSIS', link: { to: 'disease', id: 'DIS-LP' } },
        ...
        },
        {
          ...
          tiles: [
            ...
            { label: '🕳️ DIAPHRAGMATIC HERNIA', link: { to: 'disease', id: 'DIS-RESP-DH' } },
    ...
    { kind: 'node', variant: 'step', text: 'IDENTIFY CAUSE CATEGORY' },
    {
      ...
      columns: [
        ...
        },
        {
          ...
          tone: 'neutral',
          tiles: [
            { label: '🫀 MVD / DCM → pulmonary oedema', link: { to: 'disease', id: 'DIS-CARD-MVD' } },
          ],
        },
      ],
    },
