...
const paleGumsRegen: FlowPage = {
  ...
  blocks: [
    ...
    // haemorrhagic (vascular / trauma). The arms sit side by side, each with a
    // horizontal row of cause categories; see mechanismSplit in flowTypes.
    mechanismSplit([
      {
        header: 'HAEMOLYSIS',
        tone: 'orange',
...
const paleGumsNonRegen: FlowPage = {
  ...
  blocks: [
    ...
    // extra-marrow (systemic disease suppressing erythropoiesis). The arms sit
    // side by side, each with a horizontal row of cause categories; see mechanismSplit.
    mechanismSplit([
      {
...
const paleGumsShock: FlowPage = {
  ...
  blocks: [
    ...
    IDENTIFY_CAUSE_STEP,
    {
      ...
      connectAfter: false,
      columns: [
        { cat: 'Vascular', tiles: [{ label: 'Hypovolaemic shock', link: { to: 'disease', id: 'DIS-SHOCK-HYPOVOL' } }] },
        { cat: 'Inflammatory', tiles: [{ label: 'Distributive / septic shock', link: { to: 'disease', id: 'DIS-SHOCK-SEPTIC' } }] },
        { cat: 'Trauma', tiles: [{ label: 'Traumatic shock', link: { to: 'disease', id: 'DIS-SHOCK-TRAUMA' } }] },
      ],
    },
    { kind: 'disclaimer' },
  ],
