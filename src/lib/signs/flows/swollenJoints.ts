    ...
    { kind: 'node', variant: 'step', text: 'SINGLE JOINT vs VECTOR-BORNE POLY?' },
    {
      ...
      columns: [
        ...
        },
        {
          ...
          tone: 'violet',
          tiles: [
            { label: '🕷️ LYME (Borrelia)', link: { to: 'disease', id: 'DIS-INFECT-LYME' } },
            { label: '🦟 ANAPLASMOSIS', link: { to: 'disease', id: 'DIS-INFECT-ANAP' } },
            { label: '🦠 EHRLICHIOSIS', link: { to: 'disease', id: 'DIS-INFECT-EHRLICH' } },
...
const swollenJointsImmune: FlowPage = {
  ...
  blocks: [
    { kind: 'node', variant: 'entry', text: '🛡️ IMMUNE-MEDIATED', sub: 'Culture-negative neutrophilic inflammation · multiple DISTAL joints (carpi + tarsi) · young–middle-aged · fever of unknown origin · CRP usually elevated' },
      ...
      columns: [
        ...
        },
        {
          ...
          tiles: [
            ...
            { label: '☠️ OSTEOSARCOMA (juxta-articular)', link: { to: 'disease', id: 'DIS-NEO-OSA' } },
          ],
        },
      ],
    },
