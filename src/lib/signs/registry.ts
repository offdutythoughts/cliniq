...
export const SIGNS: SignEntry[] = [
  ...
  { id: 'abnormal-pupil', icon: '🔵', title: 'Anisocoria / Abnormal Pupil', sub: 'Ophthalmic vs neurological · light/dark room rule · PLR battery', flowId: 'abnormal-pupil',
  ...
  { id: 'anorexia', icon: '🍽️', title: 'Anorexia / Hyporexia', sub: 'Pseudo- vs true · cat = lipidosis emergency', flowId: 'anorexia',
  ...
  { id: 'ataxia', icon: '🚶', title: 'Ataxia', sub: 'Cerebellar vs vestibular vs proprioceptive', flowId: 'ataxia',
  ...
  { id: 'cyanosis', icon: '💙', title: 'Cyanosis', sub: 'Central/respiratory vs R→L shunt vs methaemoglobinaemia', flowId: 'cyanosis',
  ...
  { id: 'diarrhoea', icon: '💦', title: 'Diarrhoea', sub: 'Small bowel vs large bowel diagnostic approach', flowId: 'diarrhoea',
  ...
  { id: 'dysphagia', icon: '😮', title: 'Dysphagia / Gagging', sub: 'Oral · pharyngeal · oesophageal localisation', flowId: 'dysphagia',
  ...
  { id: 'dyspnoea', icon: '🌬️', title: 'Dyspnoea', sub: 'Respiratory pattern → anatomical location', flowId: 'dyspnoea',
  ...
  { id: 'epistaxis', icon: '👃', title: 'Epistaxis', sub: 'Local (intranasal) vs systemic disease', flowId: 'epistaxis',
  ...
  { id: 'fever', icon: '🌡️', title: 'Fever / FUO', sub: 'True fever vs hyperthermia · infectious / immune / neoplastic', flowId: 'fever',
  ...
  { id: 'haematuria', icon: '🩸', title: 'Haematuria', sub: 'Upper tract · bladder · urethra · prostate · genital · systemic', flowId: 'haematuria',
  ...
  { id: 'heart-murmur', icon: '🫀', title: 'Heart Murmur', sub: 'Grade I–VI · PMI → lesion · acquired vs congenital vs functional', flowId: 'heart-murmur',
  ...
  { id: 'jaundice', icon: '🟡', title: 'Jaundice', sub: 'Pre-hepatic, hepatic, post-hepatic', flowId: 'jaundice',
  ...
  { id: 'melena', icon: '⬛', title: 'Melena / Haematochezia', sub: 'Upper (digested) vs lower (fresh) GI bleeding', flowId: 'melena',
  ...
  { id: 'oedema', icon: '🫧', title: 'Peripheral Oedema', sub: 'Hypoalbuminaemia vs hydrostatic/cardiac vs vasculitis', flowId: 'oedema',
  ...
  { id: 'pollakiuria', icon: '🚽', title: 'Pollakiuria / Stranguria', sub: 'Obstruction first → bladder vs urethra vs prostate · LUT', flowId: 'pollakiuria',
  ...
  { id: 'polyphagia', icon: '🍖', title: 'Polyphagia', sub: 'With weight loss vs weight gain/drug-induced', flowId: 'polyphagia',
  ...
  { id: 'pupd', icon: '💧', title: 'Polyuria / Polydipsia', sub: 'USG-guided stepwise approach', flowId: 'pupd',
  ...
  { id: 'red-eye', icon: '👁️', title: 'Red Eye', sub: 'Where, what & how — ocular coats vs iris vs intraocular bleed vs orbit', flowId: 'red-eye',
  ...
  { id: 'regurgitation', icon: '🔄', title: 'Regurgitation', sub: 'Stepwise diagnostic workup',
  ...
  { id: 'tremors', icon: '〰️', title: 'Tremors', sub: 'Toxic/metabolic vs cerebellar vs idiopathic shaker', flowId: 'tremors',
  ...
  { id: 'vomiting', icon: '🤢', title: 'Vomiting', sub: 'True vomit vs regurgitation → primary or secondary GI', flowId: 'vomiting',
  ...
  { id: 'weakness', icon: '⚡', title: 'Weakness / Collapse', sub: 'Triage hub · Episodic · persistent · collapse ± LOC · cardiogenic vs non-cardiogenic', flowId: 'weakness',
  ...
  { id: 'weight-loss', icon: '📉', title: 'Weight Loss', sub: 'Appetite pivot — malassimilation/hypermetabolism vs reduced intake', flowId: 'weight-loss',
  ...
  { id: 'wet-eye', icon: '😢', title: 'Wet Eye / Epiphora', sub: 'Increased production vs reduced drainage · Jones test · NLS flush', flowId: 'wet-eye',
