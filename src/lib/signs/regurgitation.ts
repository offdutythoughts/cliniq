...
`<div style="display:flex;gap:6px;margin-bottom:14px;flex-wrap:wrap;"><div class="dx-step" style="flex:1;min-width:0;padding:6px 10px;font-size:10px;cursor:pointer;text-align:center;${active==='history'?'':'opacity:.65;'}" onclick="renderDxRegurgitationHistory()">📋 History</div><div class="dx-step alt" style="flex:1;min-width:0;padding:6px 10px;font-size:10px;cursor:pointer;text-align:center;${active==='exam'?'':'opacity:.65;'}" onclick="renderDxRegurgitationExam()">🩺 Exam</div><div class="dx-step" style="flex:1;min-width:0;padding:6px 10px;font-size:10px;cursor:pointer;text-align:center;${active==='dx'?'':'opacity:.65;'}" onclick="renderDxRegurgitation()">🔬 Diagnostics</div></div>`;

// ── Diagnostic approach — EXAM ───────────────────────────────────────────────
export const regurgitationExamHtml = `
${dxTabs('exam')}
...
export const regurgitationDxHtml = `
${dxTabs('dx')}
